 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".slider-video__slider")) new core(".slider-video__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
        ...
        if (document.querySelectorAll("#form").length > 0) $("#form").parsley().on("field:validated", (function() {
            var ok = 0 === $(".parsley-error").length;
            if (!ok) $(".form__button").addClass("btn-err"); else $(".form__button").removeClass("btn-err");
        }));
        if (document.querySelectorAll("#form-popup").length > 0) $("#form-popup").parsley().on("field:validated", (function() {
            var ok = 0 === $(".parsley-error").length;
            if (!ok) $(".form__button").addClass("btn-err"); else $(".form__button").removeClass("btn-err");
        }));
